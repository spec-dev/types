...
export namespace cToken {
    ...
    export type CTokenEvents =
        ...
        | 'Transfer'
        | 'Approval'
    export interface CTokenEventsContext {
        AccrueInterest(
            parameters: {
                filter?: {}
                fromBlock?: number
    ...
    export interface CToken {
         ...
         */
        repayBorrow(repayAmount: string): MethodReturnContext
        /**
         * Payable: false
         * Constant: true
         * StateMutability: view
         ...
         * @param repayAmount Type: uint256, Indexed: false
         */
        repayBorrowBehalf(borrower: string, repayAmount: string): MethodReturnContext
        /**
         * Payable: false
         * Constant: true
         * StateMutability: view
         ...
         * Type: function
         */
        underlying(): MethodConstantReturnContext<string>
        /**
         * Payable: false
         * Constant: true
         * StateMutability: view
         ...
         */
        mint(mintAmount: string): MethodReturnContext
        /**
         * Payable: false
         * Constant: false
         * StateMutability: nonpayable
         ...
         * StateMutability: nonpayable
         * Type: constructor
         * @param underlying_ Type: address, Indexed: false
